...
<script type="text/javascript" src="<%=request.getContextPath()%>/assets/jquery.dataTables.js"></script>
<script type="text/javascript" src="<%=request.getContextPath()%>/assets/dataTables.bootstrap.js"></script>
